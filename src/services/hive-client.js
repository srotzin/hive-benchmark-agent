...
const DID='did:hive:hiveforce-benchmark';const ID={name:'HiveForce-Benchmark',purpose:'Performance benchmarking — latency testing, throughput measurement, reliability scoring',capabilities:["latency_testing","throughput_measurement","reliability_scoring","regression_detection"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-benchmark-agent',purpose:ID.purpose})}
